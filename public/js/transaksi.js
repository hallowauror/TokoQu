...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  watch: {
    ...
    'customer.email_customer': function customerEmail_customer() {
  ...
  methods: {
    ...
    addToCart: function addToCart() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/cart', this.cart).then(function (response) {
        setTimeout(function () {
          ...
          _this3.shoppingCart = response.data; //mengkosongkan variable
    ...
    removeCart: function removeCart(id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          //kirim data keserver
          axios__WEBPACK_IMPORTED_MODULE_1___default.a["delete"]('/api/cart/' + id).then(function (response) {
            // load cart baru
            _this5.getCart();
          })["catch"](function (error) {
            console.log(error);
      ...
      if (this.customer.email_customer != '' && this.customer.name_customer != '' && this.customer.phone_customer != '' && this.customer.address_customer != '') {
        ...
        this.$swal({
          ...
          if (result.value) {
            ...
            _this7.submitForm = true; //mengirimkan data dengan uri /checkout
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/checkout', _this7.customer).then(function (response) {
              setTimeout(function () {
                ...
                _this7.getCart(); //message di-set untuk ditampilkan


                _this7.message = response.data.message; //form customer dikosongkan
...
module.exports = __webpack_require__(/*! D:\Tugas Akhir\si_management_olshop\resources\js\transaksi.js */"./resources/js/transaksi.js");

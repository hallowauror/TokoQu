...
new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    searchCustomer: function searchCustomer() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/customer/search', {
        ...
        if (response.data.status == 'success') {
          ...
          _this2.resultStatus = true;
        }

        _this2.formCustomer = true;
    ...
    sendOrder: function sendOrder() {
      ...
      this.errorMessage = '';
      this.message = ''; // Jika var customer tidak kosong 
          ...
          if (result.value) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/checkout', _this3.customer).then(function (response) {
              setTimeout(function () {
                ...
                _this3.getCart(); //message di-set untuk ditampilkan


                _this3.message = response.data.message; //form customer dikosongkan
    ...
    addToCart: function addToCart() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/api/cart', this.cart).then(function (response) {
        setTimeout(function () {
          ...
          _this5.shoppingCart = response.data; //mengosongkan var

          _this5.cart.product_id = '';
          _this5.cart.qty = 1;
          _this5.product = {
            id_product: '',
            sell_price: '',
...
module.exports = __webpack_require__(/*! C:\Ega\TokoQu\resources\js\transaksi.js */"./resources/js/transaksi.js");

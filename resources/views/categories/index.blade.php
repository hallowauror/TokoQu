                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('kategori.destroy', $row->id_category) }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="_method" value="DELETE">

                                                    <a href="{{ route('kategori.edit', $row->id_category) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
